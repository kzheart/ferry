...
Ferry is a desktop session manager for Claude Code, Codex CLI, and OpenCode. It brings local conversations from different coding agents into one place and helps you carry useful context between them.
...
- Check for updates in the app, show download progress, and install updates after confirmation.

Ferry is available for Apple Silicon macOS and 64-bit Windows.
