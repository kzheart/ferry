...
export const TOOL_GLYPH = {
  ...
  session_cleanup: '<path d="M2.5 4.2h11M6 4.2V2.4h4v1.8M4.3 6v7.4h7.4V6M6.3 7.8v3.8M9.7 7.8v3.8" fill="none" stroke="currentColor" stroke-width="1.35" stroke-linecap="round" stroke-linejoin="round"/>',
