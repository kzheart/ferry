...
export const TOOL_GLYPH = {
  ...
  session_delete: '<path d="M2.5 4.2h11M6 4.2V2.4h4v1.8M4.3 6v7.4h7.4V6" fill="none" stroke="currentColor" stroke-width="1.35" stroke-linecap="round" stroke-linejoin="round"/><path d="M6.6 8.1l2.8 2.8M9.4 8.1l-2.8 2.8" stroke="currentColor" stroke-width="1.35" stroke-linecap="round"/>',
  ask_user: '<path d="M2.3 3.1h11.4v8H8.6l-2.8 2v-2H2.3z" fill="none" stroke="currentColor" stroke-width="1.35" stroke-linejoin="round"/><path d="M8 5.2v.2M8 7v2.1" stroke="currentColor" stroke-width="1.4" stroke-linecap="round"/>',
