  ...
  const copy = () =>
    mutate(async () => {
      ...
      const result = await ferry.copyRole(
        selected.id,
        nextId,
        `${selected.name} ${t("settings:roles.copySuffix")}`,
      );
    ...
    <div style={{ flex: 1, minHeight: 0, display: "flex" }}>
      <div
        ...
        style={{
          width: 220,
          overflowY: "auto",
          borderRight: "1px solid var(--line4)",
          padding: 12,
        }}
      >
        <button
        ...
        <div style={{ display: "grid", gap: 12, maxWidth: 560 }}>
          ...
          <label style={{ fontSize: 11, color: "var(--tx4)" }}>
            ...
            <textarea
              ...
              disabled={selected?.builtin && !creating}
              onChange={(event) =>
                setDraft((value) => ({ ...value, persona: event.target.value }))
              }
          ...
          >
            <legend
              style={{ fontSize: 11, color: "var(--tx4)", marginBottom: 6 }}
            >
              {t("settings:roles.tools")}
            </legend>
          ...
          <label style={{ fontSize: 11, color: "var(--tx4)" }}>
            ...
            >
              ...
              <option value="medium">
                {t("settings:roles.thinkingMedium")}
              </option>
          ...
          <label style={{ fontSize: 11, color: "var(--tx4)" }}>
            ...
            <select
              className="finput"
              value={draft.apply_policy}
              disabled={selected?.builtin && !creating}
              onChange={(event) =>
                setDraft((value) => ({
                  ...value,
                  apply_policy: event.target.value,
                }))
              }
              style={{ display: "block", marginTop: 5 }}
            >
          ...
          {error && (
            <div style={{ color: "var(--err-text)", fontSize: 11 }}>
              {error}
            </div>
          )}
