...
OperationInput = EditOperationInput | MigrationOperationInput | MetadataOperationInput | DeleteOperationInput

OPERATION_PLAN_ID_PREFIX = 'op_'
OPERATION_KINDS = frozenset(('edit', 'migration', 'metadata', 'delete'))
